    ...
    for depth in range(start_depth, end_depth+1):
        ...
        for i in range(no_folds):
            ...
            for num_hypothesis in range(20,21):
                ...
                print "Training: macro F1 Score: ", macro_f1_score, ", micro F1 Score: ", micro_f1_score, ", Accuracy: ", accuracy

                macro_f1_score, accuracy, micro_f1_score = get_inference(hypothesis, alphas, valid_norm, valid_labels)
                print "Validation: macro F1 Score: ", macro_f1_score, ", micro F1 Score: ", micro_f1_score, ", Accuracy: ", accuracy
                ...
                print "Test: macro F1 Score: ", macro_f1_score, ", micro F1 Score: ", micro_f1_score, ", Accuracy: ", accuracy
